#!/bin/bash
# ================================================================
# Script: run_cords_phi2_full_sampled.sh
#
# Purpose:
#   Run cords_phi2_full_sampled with
...
declare -A DATASET_SAMPLES=(
  ["dmv"]="1000 2000 4000 8000 16000 11591877"
  ["census"]="1000 2000 4000 8000 16000 48842"
...
for DATASET in "${!DATASETS[@]}"; do
    ...
    OUT_DIR="${RESULT_ROOT}/${DATASET}/phi2_full_sampled"
    LOG_DIR="${LOG_ROOT}/${DATASET}/phi2_full_sampled"
